...
// Accompanying text: moved ABOVE chart, 50% larger (14 → 21px)
const accomp = { fontSize: 21, color: 'var(--text-dark)', lineHeight: 1.6, margin: '0 0 20px' }
...
export default function TrailForward() {
  ...
  return (
    <div id="panel-trail-forward" role="tabpanel" aria-labelledby="tab-trail-forward" tabIndex={-1}>
      ...
      {/* ── BLUE BANNER — Urgency to Act ── */}
      <div style={{ backgroundColor: 'var(--navy)' }}>
        <div style={bannerPad}>
          <h2 style={{ margin: '0 0 10px', fontSize: 40, color: 'white', fontFamily: "'Source Serif 4', serif" }}>
            Urgency to Act
          </h2>
          <p style={{ margin: '0 0 6px', fontSize: 17, color: 'rgba(255,255,255,0.7)', fontFamily: "'Source Sans 3', sans-serif" }}>
            The past 15 years show the ripple effects of the city's affordable housing crisis.
          </p>
          <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 760 }}>
      ...
      {/* ── BLUE BANNER — Our Trail Forward ── */}
      <div style={{ backgroundColor: 'var(--navy)', borderTop: '1px solid rgba(255,255,255,0.15)' }}>
        <div style={bannerPad}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
            <h2 style={{ margin: 0, fontSize: 40, color: 'white', fontFamily: "'Source Serif 4', serif" }}>
              Our Trail Forward
            </h2>
          ...
          <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.75)', margin: '0 0 12px', maxWidth: 760 }}>
            A vibrant and healthy Steamboat Springs means having residents of all ages and incomes.
          </p>
          <p style={{ fontSize: 15, lineHeight: 1.75, maxWidth: 760, margin: 0, color: 'rgba(255,255,255,0.85)' }}>
      ...
      {/* ── BLUE BANNER — Income Deeper Dive ── */}
      <div style={{ backgroundColor: 'var(--navy)' }}>
        <div style={bannerPad}>
          <SectionHeader dark
          ...
          />
          <p style={{ margin: '14px 0 0', fontSize: 15, lineHeight: 1.75, maxWidth: 760, color: 'rgba(255,255,255,0.85)' }}>
      ...
      {/* ── BLUE BANNER — Employment Challenges ── */}
      <div style={{ backgroundColor: 'var(--navy)' }}>
        <div style={bannerPad}>
          <SectionHeader dark
